...
namespace Storage.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Get()
        {
            ...
            var product = _context.Product.Select(p => new ProductViewModel { Name = p.Name, Price = p.Price, Count = p.Count, InventoryValue= p.Price * p.Count });

            return View("ProductView", product);
        }

        public ActionResult Fil(string category)
        {
            var cat = _context.Product.Where(p => p.Category == category);
